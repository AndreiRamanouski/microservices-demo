...
public class TwitterElasticQueryWebClient implements ElasticQueryWebClient {
    ...
    @Override
    public Flux<ElasticQueryWebClientResponseModel> getDataByText(String text) {
        LOG.info("Querying by text {}", text);
        return getWebClient(ElasticQueryWebClientRequestModel.builder()
                .text(text)
                .build())
