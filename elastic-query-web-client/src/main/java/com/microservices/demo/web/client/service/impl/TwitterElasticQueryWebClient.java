package com.microservices.demo.web.client.service.impl;
...
@Service
public class TwitterElasticQueryWebClient implements ElasticWebClientInterface {
    ...
    @Override
    public ElasticQueryServiceAnalyticsResponseModel getDataByText(ElasticQueryWebClientRequestModel requestModel) {
    ...
    private WebClient.ResponseSpec getWebClient(ElasticQueryWebClientRequestModel requestModel) {
        return webClientBuilder
                ...
                .header(CORRELATION_ID_HEADER, MDC.get(CORRELATION_ID_HEADER))
